...
const Home = () => {
  ...
  return (
    ...
    <div className="container">
        ...
        <p className="lead">Prepare yourself with interview questions and test your knowledge with quizzes.</p>
...
<div className="container my-5">
    <h1 className="text-center fw-bold mb-4">Overcome Your Fear of Coding with WissenHub PRO</h1>
    ...
    <div className="row g-4">
        ...
        <div className="col-lg-4">
            <div className="p-4 bg-dark text-light rounded shadow-lg">
                <ul className="list-unstyled">
                    <li className="mb-3">
                        <h5 className="fw-bold"><i className="fas fa-laptop-code me-2 text-success"></i> Hands-on Learning</h5>
                        <p className="text-muted">Practice what you learn with our interactive courses, problems, and quizzes.</p>
                    </li>
                    <li className="fw-bold"><i className="fas fa-tasks me-2 text-primary"></i> Practice Projects</li>
                    <li className="fw-bold"><i className="fas fa-lightbulb me-2 text-warning"></i> Coding Challenges</li>
                    <li className="fw-bold"><i className="fas fa-robot me-2 text-danger"></i> AI Mentor</li>
                    <li className="fw-bold"><i className="fas fa-certificate me-2 text-info"></i> Professional Certificates</li>
                </ul>
            </div>
        </div>
        ...
        <div className="col-lg-8">
            <div className="p-4 bg-dark text-light rounded shadow-lg">
                <h5 className="fw-bold text-success">Offer: 50% Off till March 2025</h5>
                <h3 className="fw-bold">Get Hired from Top MNCs</h3>
                <img src="https://img.freepik.com/free-vector/gamer-playing-with-computer_52683-15038.jpg" className="img-fluid rounded shadow-sm mt-3" alt="Student studying"/>
            </div>
        </div>
    </div>
    ...
    <div className="text-center mt-4">
        <a href="#" className="btn btn-primary btn-lg">Try WissenHub PRO →</a>
    </div>
</div>
        ...
        <div className="col-md-4">
            <div className="card text-center shadow-lg border-0">
                <div className="card-body">
                    ...
                    <p className="">We're active programmers creating resources we wish we had when learning to code.</p>
                </div>
            </div>
        </div>
        ...
        <div className="col-md-4">
            <div className="card text-center shadow-lg border-0">
                <div className="card-body">
                    ...
                    <p className="">We believe in honest, practical learning that prepares you for real-world challenges.</p>
                </div>
            </div>
        </div>
        ...
        <div className="col-md-4">
            <div className="card text-center shadow-lg border-0">
                <div className="card-body">
                    ...
                    <p className="">Every concept includes complete code examples you can run, modify, and apply.</p>
                </div>
            </div>
        </div>
    </div>
